        ...
        <div className="p-4 md:p-8 space-y-8 max-w-7xl mx-auto w-full">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {filteredCategories.map((cat) => (
                        <div
                            ...
                            key={cat.id}
                            onClick={() => showToast(`Membuka kategori "${cat.title}"...`)}
                        >
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                <div className="p-8 flex flex-col md:flex-row items-center justify-between gap-6">
                    ...
                    <button
                        onClick={() => window.open("https://wa.me/6281234567890?text=Halo%2C%20saya%20butuh%20bantuan", "_blank")}
                        className="inline-flex items-center gap-2 px-6 py-3 bg-wa-green text-white font-semibold rounded-lg hover:bg-wa-dark transition-colors shadow-sm text-sm"
                    >
