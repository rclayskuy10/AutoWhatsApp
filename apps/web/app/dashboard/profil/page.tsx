                    ...
                    <form onSubmit={handleSaveProfile}>
                        <div className="flex flex-col md:flex-row gap-8">
                            ...
                            <div className="flex flex-col items-center gap-4">
                                <div className="w-32 h-32 rounded-full bg-gray-100 flex items-center justify-center text-4xl font-bold text-gray-400 border-4 border-white shadow-lg overflow-hidden relative group">
                                ...
                                <button type="button" className="text-wa-dark text-sm font-medium hover:underline">Ubah Foto Profil</button>
                            </div>
                ...
                <div className="p-8">
                    <form onSubmit={handleUpdatePassword}>
                        ...
                        <div className="mt-6 flex justify-end items-center gap-4">
                            <a className="text-sm text-gray-500 hover:text-gray-700" href="#">Lupa kata sandi?</a>
                            <button
                                type="submit"
